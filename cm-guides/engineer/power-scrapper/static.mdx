...
3.  <Skill name="shreddergyro" />
4.  <Skill name="sneakgyro" />
5.  <Skill name="functiongyro"/>
6.  <Skill name="medicgyro" />
7.  Take _Mistlock Singularity_
8.  <Skill name="medicgyro" />
...
Cast your <Skill name="minefield" /> and be careful to time <Skill name="blastgyro" /> into <Skill name="thunderclap" profession="engineer" /> for when the boss becomes vulnerable (very important CC contribution).
...
5. <Skill name="throwmine" profession="engineer" />
6. <Skill name="functiongyro" />
7. <Skill name="bypasscoating" />
8. <Skill name="detonateminefield" />
9. <Skill name="grenadebarrage" />
10. <Skill name="electrowhirl" />
11. <Skill name="shrapnelgrenade" />
12. <Skill name="poisongrenade" />
13. <Skill name="freezegrenade" />
14. <Skill name="minefield" />
...
7. <Skill name="detonateminefield" />
...
5. <Skill name="detonateminefield" />
6. <Skill name="shrapnelgrenade" />
7. <Skill name="poisongrenade" />
...
6. <Skill name="grenadebarrage" />
7. <Skill name="detonateminefield" />
8. <Skill name="shockshield" /> (or dodge)
9. <Skill name="poisongrenade" />
10. <Skill name="electrowhirl" />
...
1. On Boss (Precasted)
   1. <Skill name="bigolbomb" />
   2. <Skill name="shreddergyro" /> / <Skill name="blastgyro" />
2. <Skill name="thunderclap" profession="engineer" />
3. <Skill name="electrowhirl" />
4. <Skill name="shrapnelgrenade" />
5. <Skill name="grenadebarrage" />
